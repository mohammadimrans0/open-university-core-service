...
import { AcademicSemesterFilterAbleFields as AcademicSemesterFilterAbleFields } from './academicSemester.constants'
...
const insertIntoDB = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse<AcademicSemester>(res, {
    ...
    success: true,
    message: 'Academic Seamster Created!!',
    data: result,
  })
})
...
const getAllFromDB = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
    message: 'Academic Seamster data fetched!!',
    meta: result.meta,
    data: result.data,
  })
})
