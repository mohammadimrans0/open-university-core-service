...
const calculateCgpaAndGrade = (payload: (StudentEnrolledCourse & {course: Course})[]) => {
...
export const StudentEnrolledCourseMarkUtils = {getGradeFromMarks, calculateCgpaAndGrade}